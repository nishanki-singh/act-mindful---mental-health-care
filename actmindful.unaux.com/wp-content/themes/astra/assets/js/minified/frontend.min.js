...
! function() {
    ...
    window.addEventListener("resize", function() {
        ...
        var e, t;
        AstraToggleSetup(), t = d.classList.contains("ast-header-break-point") ? (e = document.getElementById("ast-mobile-site-navigation"), document.getElementById("ast-mobile-header")) : (e = document.getElementById("ast-desktop-site-navigation"), document.getElementById("ast-desktop-header")),
            function(e, t) {
                if (e) {
